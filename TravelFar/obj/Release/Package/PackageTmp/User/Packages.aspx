<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Packages.aspx.cs" Inherits="TravelFar.User.Packages" %>
				...
				<div class="container">				
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white link-nav"><a href="Default.aspx">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="Packages.aspx"> Tour Packages</a></p>
						</div>	
					</div>
				</div>
			</section>
				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-lg-4">
							<div class="single-destinations">
								<div class="thumb">
									<img src="../UserTemplate/img/packages/d2.jpg" alt=""/>
								</div>
								<div class="details">
									<h4>Holiday Sea beach Blue Ocean</h4>
									<p>
						...
						<div class="col-lg-4">
							<div class="single-destinations">
								<div class="thumb">
									<img src="../UserTemplate/img/packages/d3.jpg" alt="">
								</div>
								<div class="details">
									<h4>Holiday Sea beach Blue Ocean</h4>
									<p>
						...
						<div class="col-lg-4">
							<div class="single-destinations">
								<div class="thumb">
									<img src="../UserTemplate/img/packages/d4.jpg" alt="">
								</div>
								<div class="details">
									<h4>Holiday Sea beach Blue Ocean</h4>
									<p>
						...
						<div class="col-lg-4">
							<div class="single-destinations">
								<div class="thumb">
									<img src="../UserTemplate/img/packages/d5.jpg" alt="">
								</div>
								<div class="details">
									<h4>Holiday Sea beach Blue Ocean</h4>
									<p>
						...
						<div class="col-lg-4">
							<div class="single-destinations">
								<div class="thumb">
									<img src="../UserTemplate/img/packages/d6.jpg" alt="">
								</div>
								<div class="details">
									<h4>Holiday Sea beach Blue Ocean</h4>
									<p>
						...
						<div class="col-lg-3  col-md-6 col-sm-6">
							<div class="single-footer-widget mail-chimp">
								...
								<ul class="instafeed d-flex flex-wrap">
									<li><img src="../UserTemplate/img/i1.jpg" alt=""/></li>
									<li><img src="../UserTemplate/img/i2.jpg" alt=""/></li>
									<li><img src="../UserTemplate/img/i3.jpg" alt=""/></li>
									<li><img src="../UserTemplate/img/i4.jpg" alt=""/></li>
									<li><img src="../UserTemplate/img/i5.jpg" alt=""/></li>
									<li><img src="../UserTemplate/img/i6.jpg" alt=""/></li>
									<li><img src="../UserTemplate/img/i7.jpg" alt=""/></li>
									<li><img src="../UserTemplate/img/i8.jpg" alt=""/></li>
								</ul>
							</div>
						</div>						
					</div>
